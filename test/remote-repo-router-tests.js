...
var repo = require('../index'), https = require('https'), http = require('http');
// ------------------------------
// set up the routes
// ------------------------------
...
var parser_repo = new repo.MemoryRepo(), parser_version_repo = new repo.MemoryRepo();
// PARSER ROUTES
...
describe('Remote Repo (alternate parameterization)', function () {
    ...
    it('POST(create) should create a library', function (done) {
        remote_repo2.create({ name: 'foo', version: 'v1.1.1' }, 'My favorite equations')
            .should.eventually.equal(true).and.notify(done);
    });
    it('POST(create) should create a library', function (done) {
        // FOR TESTING THE READ ONLY BUFFER
        remote_repo2.create({ name: 'bar', version: 'v1.1.1' }, 'My favorite equations')
            .should.eventually.equal(true).and.notify(done);
    });
    ...
    it('POST(create) should not create a previous version', function (done) {
        remote_repo2.create({ name: 'foo', version: 'v1.1.0' }, 'My favorite equations')
...
//# sourceMappingURL=remote-repo-router-tests.js.map