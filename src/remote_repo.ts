...
import { deferred_repository, remote_repo_config, package_loc, resource_data } from "version-repo/src/typings"
import { validate_options, validate_options_range } from 'version-repo/index';
...
//--     }
    ...
    fetch(options:package_loc){
        ...
        return new Promise((resolve) => {
            resolve(validate_options_range(options))
        })
        .then( (options:package_loc)  => {
